namespace Pintle.Diagnostics
{
	...
	public abstract class LogProvider : ILogProvider
	{
		...
		public void Log(SeverityLevel level, string message, object owner, Exception exception = null)
		{
			...
			if ((int) level <= (int) this.LogLevel)
			{
				switch (level)
				{
		...
		public abstract void Audit(string message, object owner);

		public abstract void Debug(string message, object owner);

		public abstract void Info(string message, object owner);

		public abstract void Warn(string message, object owner, Exception exception = null);

		public abstract void Error(string message, object owner, Exception exception = null);

		public abstract void Fatal(string message, object owner, Exception exception = null);
	}
}